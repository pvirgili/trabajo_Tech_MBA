...
const SYSTEM_MESSAGE_CHAT_CONVERSATION = `Assistant helps users with questions regarding data about their company, projects, stakeholerds and so on. Be brief in your answers.
